...
' (Version: 2020/08/26) IBase_create_resParamValue
' (Version: 2020/08/27) IUser_translate_resParamValue
' (Version: 2020/08/23) IUser_translate_json_strContent
'
'***********************************************************************************************
...
Function IUser_translate_json_strContent(ByVal strContent)
	...
	'--- Translate 'arrValue' ----------------------------------------------------------------------
	For cnt1 = 0 to UBound(arrValue)
		existValue 	  = IUser_translate_resParamValue(arrValue(cnt), "")
		arrValue(cnt) = existValue
	Next 
